 ...
 * @author david
 */
public class viewAddCuenta extends javax.swing.JFrame {

    /**
     * Creates new form viewAddCuenta
     */
    public viewAddCuenta() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel2.setText("CodigoSocio:");

        jLabel3.setText("Fecha de Apertura");

        jLabel4.setText("Estado:");

        jLabel5.setText("Oficial de Cuenta:");

        jLabel6.setText("Saldo:");

        jLabel7.setText("Ultimo Mov:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewAddCuenta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new viewAddCuenta().setVisible(true);
            }
        });
    }
