 ...
 * @author david
 */
public class viewAddSocio extends javax.swing.JFrame {

    /**
     * Creates new form viewAddSocio
     */
    public viewAddSocio() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Nombre Usual");

        jLabel6.setText("Relacion Aseguradora");

        jLabel7.setText("Exonerado Impuestos");

        jLabel8.setText("Grupo Economico");

        jLabel9.setText("Relacion");

        jLabel14.setText("Ejecutivo");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(viewAddSocio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new viewAddSocio().setVisible(true);
            }
        });
    }
